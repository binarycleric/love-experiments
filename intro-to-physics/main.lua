...
function love.load()
  ...
  -- creating the ground
  local ground_body = love.physics.newBody(world, 800/2, 650-50/2)
  local ground_shape = love.physics.newRectangleShape(650, 50)
  ...
  local block2_shape = love.physics.newRectangleShape(0, 0, 100, 30)
  ...
  local block3_shape = love.physics.newRectangleShape(0, 0, 50, 125)
  local block3_fixture = love.physics.newFixture(block3_body, block3_shape, 2)
